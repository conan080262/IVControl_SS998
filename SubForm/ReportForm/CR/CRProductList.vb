...
Public Class CRProductList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IVControl_SS998.CRProductList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProductList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProductList = New CRProductList()
        rpt.Site = Me.Site
        Return rpt
    End Function
